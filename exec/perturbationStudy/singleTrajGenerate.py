...
def main():
    ...
    manipulatedVariables['perturbQuantile'] = [0.5]#[0.3, 0.4, 0.5, 0.6, 0.7]
    ...
    saveTrajectoryByParameters = lambda trajectories, trajectoryFixedParameters, parameters: saveToPickle(trajectories,
                                                                                                          getTrajectorySavePath(
                                                                                                              ...
                                                                                                              parameters))
    numTrajectories = 200
    parameters = parametersAllCondtion[0]


    valuePriorEndTime = -100
    deviationFor2DAction =  1.0 #TODO: deviation for 2d action
    ...
    for trajectoryId in range(numTrajectories):
        ...
        samplePerturbedActions = SamplePerturbedActions(perturbQuantile, perturbValueDict, perturbID, perturbDim, sampleActionMultiAgent)
    ...
    saveTrajectoryByParameters(trajectoriesWithIntentionDists, trajectoryFixedParameters, parameters)
